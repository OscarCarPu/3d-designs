...
alt = {
    ...
    "paso2": "Los dos railes unidos por dos galgas naranjas",
    "paso3": "El conjunto contra el tablero con las ocho marcas de taladro",
    "paso5": "Railes colgados del tablero con sus ocho tornillos",
    "paso6": "Modulo del M920q entrando deslizando por el canal del rail",
    "paso7": "Cuna de bloqueo entrando por la boca del canal",
